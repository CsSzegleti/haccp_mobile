...
class MenuItemResourceApi {
  MenuItemResourceApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  /// Performs an HTTP 'DELETE /api/v1/menu/item/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] id (required):
  ...
  /// Performs an HTTP 'GET /api/v1/menu/item/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] id (required):
